...
<body>
	...
	<div class="ui container">
		...
		<div class="html ui top attached segment" id="outputPanel"
			style="display: none">
			<div class="ui top attached label">HPO Output</div>
			<div class="ui warning message">
				<div class="header"> Please make correction on the parsing panel.
				</div>
					This is automated parsing results. Human inspections are required to guarantee the accuracy.
			</div>
			...
			<div class="ui secondary submit button" id="geneButton">Get
				Genes</div>
		</div>

		<div class="html ui top attached segment" id="genePanel"
			style="display: none">
			<div class="ui top attached label">Gene Output</div>
			<div class="ui warning message">
				<div class="header"> The gene prioritization results are generated by <a href='http://phen2gene.wglab.org/' target="_blank">Phen2Gene</a>
				</div>
				predicted gene is based on searching along the gene-gene interaction network.
			</div>
